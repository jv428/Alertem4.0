...
var operacion = document.getElementById('operacion_ac').value;
...
if( operacion =="actualizar"){
	...
	document.getElementById('btnactualizar').addEventListener('click', function(e){
		...
		var id_ac = document.getElementById('id_ac').value;	 
		fntFetchFormulario(operacion,'POST','../Controladores/controlador_actividad.php',formulario,'respuesta',id_ac);
...
if( operacion =="guardar"){
	document.getElementById('btnguardar').addEventListener('click', function(e){
		...
		var operacion = document.getElementById('operacion_ac').value;	 
		fntFetchFormulario(operacion,'POST','../Controladores/controlador_actividad.php',formulario,'respuesta',null);
