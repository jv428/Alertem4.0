...
var operacion = document.getElementById('operacion_gr').value;
if( operacion =="actualizar"){
	...
	document.getElementById('btnactualizar').addEventListener('click', function(e){
		...
		var id_gr = document.getElementById('id_gr').value;	 
		fntFetchFormulario(operacion,'POST','../Controladores/controlador_grupos.php',formulario,'respuesta',id_gr);
