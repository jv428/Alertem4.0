...
class usuario{
    ...
    function listarTabla(){
        include('conexion.php');
        $id=null;
        $ver_usuario = $bd ->query("SELECT usuarios_at.id_us, usuarios_at.documento_us,usuarios_at.nombre_us, usuarios_at.p_apellido_us, usuarios_at.s_apellido_us, usuarios_at.telefono_us, usuarios_at.direccion_us, usuarios_at.correo_us, usuarios_at.clave_us ,tipos_usuario_at.descripcion_tu, grupos_at.descripcion_gr FROM usuarios_at,tipos_usuario_at,grupos_at WHERE usuarios_at.t_usuario_us = tipos_usuario_at.id_tu AND usuarios_at.grupo_us = grupos_at.id_gr;")->fetchAll(PDO::FETCH_OBJ);
