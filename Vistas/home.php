...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Cabin&family=Roboto:wght@400;500&display=swap"
      rel="stylesheet"
    />
    <title>ALERTEM</title>
  </head>
  ...
  <div class="big">
      ...
      <div class="container">
        ...
        <div class="parrafo">
          <p>
            ALETEM 4.0 es un aplicativo académico que integra en los sistemas de
            información de las instituciones educativas procesos de gestion
            academica y disciplinaria. Asi se dara seguimiento de forma segura a
            los estudiantes en los centros educativos.
          </p>
        </div>
        <div class="btn-asesor">
    ...
    <div class="service-container">
      <section id="servicios">
        ...
        <div class="se">
          <div class="ser">
            <i class="fa-solid fa-bell" style="color:#46ce96 ;"></i><br /><br />Alertas tempranas<br />(tiempo
            real)
          </div>
          <div class="ser">
            <i class="fa-solid fa-check-double" style="color:#46ce96 ;"></i><br /><br />Calificaciones
          </div>
          <div class="ser">
            <i class="fa-solid fa-book-bookmark" style="color:#46ce96 ;"></i><br /><br />Tramite y
            estado de matrícula
          </div>
          <div class="ser">
            <i class="fa-solid fa-clipboard-user" style="color:#46ce96 ;"></i><br /><br />Atención
            acudiente
          </div>
          <div class="ser-abajo">
            <i class="fa-solid fa-calendar-check" style="color:#46ce96 ;"></i><br /><br />Calendario
            académico
          </div>
          <div class="ser-abajo">
            <i class="fa-solid fa-clock" style="color:#46ce96 ;"></i><br /><br />Horario escolar
          </div>
          <div class="ser-abajo">
            <i class="fa-solid fa-microchip" style="color:#46ce96 ;"></i><br /><br />Sistema de registro
            ágil
          </div>
        </div>
        <div class="bar"></div>
    ...
    <div class="contacto">
      <section id="contacto">
        ...
        <div class="parrafo-contacto">
          <p>
            Si te interesa integrar nuestros servicios a tu centro educativo<br />
    ...
    <footer>
      ...
      <div class="le-po">
        <div class="leg">
          <a href="" style="color:#26302a ;">Información legal</a>
        </div>
        <hr>
        <div class="po">
          <a href="" style="color:#26302a;">Politíca de privacidad</a>
        </div>
      </div>
    </footer>
  </body>
